...
def main(opt):
    ...
    for epoch in range(opt.max_epoch):
        ...
        # cat_feat = None
        for i, (frames, depth_feat, captions, cap_lens, video_ids) in (enumerate(train_loader, start=1)):
            ...
            # flops, params = profile(net, inputs=(frames, depth_feat, targets, epsilon))
            ...
            optimizer.zero_grad()
            outputs, _ = net(frames, depth_feat, targets, epsilon)
            tokens = outputs
            bsz = len(captions)
